...
\begin{titlepage}
    ...
    \begin{singlespace}
        ...
        \begin{abstract}
        The purpose of this document is to provide an accurate and brief descriptions of the technologies considered and chosen for the OSU USLI website, specifically front-end, back-end, and hosting services.
        \end{abstract}     
    \end{singlespace}
\end{titlepage}
\newpage
